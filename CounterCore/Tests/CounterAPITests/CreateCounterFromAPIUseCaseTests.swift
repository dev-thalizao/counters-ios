//
//  CreateCounterFromAPIUseCaseTests.swift
//  
//
...
final class CreateCounterFromAPIUseCaseTests: XCTestCase {
    ...
    func testCreateFailsOnRequestError() {
    ...
    func testCreateSucceedsOnSuccessfulRequest() {
        let (sut, client) = makeSUT()
    ...
    private func makeSUT(
        ...
        let sut = RemoteCounterCreator(client: client)
